...
echo_and_run cd "/home/ksuresh/hiro/src/components/hiro_core"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ksuresh/hiro/src/components/hiro_core/setup.py" \
    egg_info --egg-base /home/ksuresh/hiro/build/components/hiro_core \
    build --build-base "/home/ksuresh/hiro/build/components/hiro_core" \
    install \
    --root="${DESTDIR-/}" \
